...
Project Description
This is my very first web development project from The Odin Project curriculum. It is a simple recipe website built entirely from scratch using HTML. The goal of this project is to practice creating a multi-page website, structuring text, linking pages together, and working with basic media elements like images.

 Demonstrated Skills: 
By the time I complete this project, I will have successfully demonstrated the following skills:
